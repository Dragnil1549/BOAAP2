...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	for (;;)
	{
		...
		cout << "7 - подсчёт четных элементов" << endl;
		cout << "0 - выход" << endl;
		...
		case 6:
			while (demoTree.Root)
				demoTree.deleteByNode(demoTree.Root) ? cout << "дерево сбалансировано" << endl : cout << "дерево не сбалансировано" << endl;
			break;
		case 7:
			cout << demoTree.zad(demoTree.Root, funct) << endl;
			break;
		}
	}
	return 0;
